...
export const servicenowSkills = [
  {
    ...
    name: 'ITSM Core',
    level: 95,
    description: 'Expert-level incident, problem, change, and service catalog management with DevOps integration and AI-powered automation',
    experience: '3.6 years',
    projects: ['VW Group ITSM', 'Infosys Enterprise Platform', 'Multi-regional deployment'],
    certifications: ['ITSM Professional Suite', 'CIS-ITSM', 'CSA'],
    achievements: ['25% incident backlog reduction', '5000+ user deployment', '98% SLA compliance', 'DevOps change velocity optimization']
  },
  {
    id: 2,
    name: 'Virtual Agent & NLU',
    level: 90,
    description: '80% accuracy improvements with advanced NLU training, conversation design, and multi-language support implementation',
    experience: '2 years',
    projects: ['Enterprise VA Optimization', 'ChatGPT Integration', 'Multi-language support'],
    certifications: ['ITSM Professional Suite', 'Virtual Agent Micro-Cert'],
    achievements: ['80% NLU accuracy', '40% L1 deflection', '1000+ users supported', 'Natural language conversation flows']
  },
  {
    id: 3,
    name: 'Predictive Intelligence',
    level: 85,
    description: '30% MTTR reduction through AI models, automated classification, and intelligent routing with machine learning optimization',
    experience: '1.5 years',
    projects: ['MTTR Optimization', 'Automated Incident Routing', 'Performance Analytics'],
    certifications: ['ITSM Professional Suite', 'Predictive Intelligence Micro-Cert'],
    achievements: ['30% MTTR improvement', '95% SLA compliance', '87% classification accuracy', 'ML-powered predictions']
  },
  {
    id: 4,
    name: 'Platform Analytics',
    level: 80,
    description: 'Advanced analytics, dashboard development, KPI management, and performance measurement with real-time data visualization',
    experience: '1.5 years',
    projects: ['Performance Dashboards', 'KPI Development', 'Analytics Automation'],
    certifications: ['ITSM Professional Suite', 'CIS-PA (In Progress)'],
    achievements: ['Real-time analytics implementation', 'Executive dashboard creation', 'Performance optimization insights']
  },
  {
    id: 5,
    name: 'Platform Development',
    level: 85,
    description: 'GlideScript, Business Rules, Client Scripts, custom applications, and integration development with enterprise-scale architecture',
    experience: '3.6 years',
    projects: ['Custom Applications', 'Automation Scripts', 'Workflow Optimization'],
    certifications: ['CAD', 'CSA'],
    achievements: ['20+ automation scripts', 'Custom app development', 'Performance optimization', 'Scoped application architecture']
  },
  {
    id: 6,
    name: 'DevOps & Change Velocity',
    level: 75,
    description: 'DevOps integration, change velocity automation, continuous deployment, and agile change management practices',
    experience: '1 year',
    projects: ['DevOps Change Automation', 'Velocity Optimization', 'Continuous Integration'],
    certifications: ['ITSM Professional Suite'],
    achievements: ['Change velocity improvements', 'DevOps pipeline integration', 'Automated deployment processes']
  }
];
...
export const technicalSkills = [
  ...
  },
  {
    ...
    description: 'Building AI-powered workflows leveraging ServiceNow AI capabilities and third party tools.',
...
// Official Certifications with Credly Links
export const certifications = [
  {
    ...
    credlyUrl: 'https://www.credly.com/badges/087358bc-3dbe-421f-831b-d7c5e5095868',
    credlyProfileUrl: 'https://www.credly.com/users/shubham-soni.79915ddd',
  ...
  },
  {
    ...
    credlyUrl: 'https://www.credly.com/badges/ed6b2c38-c904-4600-abb9-1fc2cc4c9ce8',
    credlyProfileUrl: 'https://www.credly.com/users/shubham-soni.79915ddd',
  ...
  },
  {
    ...
    credlyUrl: 'https://www.credly.com/badges/87aef5a4-edcb-4ff3-9408-9fe069cae6de',
    credlyProfileUrl: 'https://www.credly.com/users/shubham-soni.79915ddd',
  ...
  },
  {
    ...
    credlyUrl: 'https://www.credly.com/badges/e47d9621-52af-480c-bda3-6a7d7cef127e',
    credlyProfileUrl: 'https://www.credly.com/users/shubham-soni.79915ddd',
...
export const getProfileSummary = () => {
  ...
  return {
    name: 'Shubham Soni',
    title: 'ServiceNow AI/ML Developer',
    experience: '3.6+ years',
