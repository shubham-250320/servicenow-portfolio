...
import { servicenowSkills, technicalSkills, businessSkills, certifications } from '../../data/skills';
                          ...
                          {[...Array(5)].map((_, i) => (
                            <div
                              ...
                              className={`w-3 h-3 rounded-full ${
                                i < Math.floor(skill.rating) ? 'bg-yellow-400' : 
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {certifications.map((cert, index) => (
                ...
                >
                  ...
                  <h4 className="font-semibold text-gray-900 text-sm leading-tight mb-3">{cert.name}</h4>
